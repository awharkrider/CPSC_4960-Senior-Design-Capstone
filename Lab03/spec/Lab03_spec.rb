require '../lib/Lab03.rb'

describe 'Lab 03 Unit Tests' do
  ...
  describe "#sum_to_n" do
    ...
    it "returns true when a negative and a positive number sum [Aaron additional test]" do
      expect(sum_to_n?([-2, 2], 0)).to be true
    end
    it "returns false for the empty array [Aaron additional test" do
      expect(sum_to_n?([], 0)).to be false
      expect(sum_to_n?([], 7)).to be false
    end
    it "returns false for an empty array [Aaron additional test]" do
      expect(sum_to_n?([], 0)).to be false
      expect(sum_to_n?([], 7)).to be false
    end
  end
